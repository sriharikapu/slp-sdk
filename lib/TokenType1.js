...
var TokenType1 = /** @class */ (function () {
    ...
    TokenType1.prototype.mintP2SH = function (mintP2SHConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var fundingWif, fundingAddress, tmpBITBOX, getRawTransactions, slpValidator, bitboxNetwork, script, p2sh_hash160, scriptPubKey, p2shAddress, result, balances, tokenId, additionalTokenQty, tokenInfo, tokenDecimals, mintQty, inputUtxos, mintTxid;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fundingWif = mintP2SHConfig.fundingWif;
                        fundingAddress = this.BITBOX.ECPair.toCashAddress(this.BITBOX.ECPair.fromWIF(fundingWif));
                        tmpBITBOX = this.returnBITBOXInstance(fundingAddress);
                        getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                        ...
                        bitboxNetwork = new slpjs.BitboxNetwork(tmpBITBOX, slpValidator);
                        fundingAddress = addy.toSLPAddress(fundingAddress);
                        script = this.BITBOX.Script.encode([
                            Buffer.from("DONA", "ascii"),
                            this.BITBOX.Script.opcodes.OP_CAT,
                            Buffer.from("CARDONA", "ascii"),
                            this.BITBOX.Script.opcodes.OP_EQUAL
                        ]);
                        p2sh_hash160 = this.BITBOX.Crypto.hash160(script);
                        scriptPubKey = this.BITBOX.Script.scriptHash.output.encode(p2sh_hash160);
                        p2shAddress = this.BITBOX.Address.fromOutputScript(scriptPubKey, "testnet");
                        return [4 /*yield*/, tmpBITBOX.Address.utxo(p2shAddress)];
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, bitboxNetwork.getAllSlpBalancesAndUtxos(p2shAddress)];
                    case 2:
                        balances = _a.sent();
                        tokenId = mintP2SHConfig.tokenId;
                        additionalTokenQty = mintP2SHConfig.additionalTokenQty;
                        return [4 /*yield*/, bitboxNetwork.getTokenInformation(tokenId)];
                    case 3:
                        tokenInfo = _a.sent();
                        tokenDecimals = tokenInfo.decimals;
                        ...
                        inputUtxos = [
                            {
                                txid: "650b81cd3d79cdc92d5920c42808532e6f065c5079ea1a2e9687b3d61013789e",
                                vout: 2,
                                amount: 0.00000546,
                                satoshis: 546
                            }
                        ...
                        // 6) Set the proper private key for each Utxo
                        inputUtxos.forEach(function (txo) { return (txo.wif = fundingWif); });
                        return [4 /*yield*/, bitboxNetwork.p2shTokenMint(tokenId, mintQty, inputUtxos, fundingWif, mintP2SHConfig.tokenReceiverWif, mintP2SHConfig.batonReceiverWif, mintP2SHConfig.bchChangeReceiverWif)];
                    case 4:
                        mintTxid = _a.sent();
                        return [2 /*return*/, mintTxid];
                }
    ...
    TokenType1.prototype.sendP2SH = function (sendP2SHConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var fundingWif, fundingAddress, tmpBITBOX, getRawTransactions, slpValidator, bitboxNetwork, script, p2sh_hash160, scriptPubKey, p2shAddress, result, balances, tokenId, sendAmount, tokenInfo, tokenDecimals, inputUtxos, sendTxid;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fundingWif = sendP2SHConfig.fundingWif;
                        fundingAddress = this.BITBOX.ECPair.toCashAddress(this.BITBOX.ECPair.fromWIF(fundingWif));
                        tmpBITBOX = this.returnBITBOXInstance(fundingAddress);
                        getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                    ...
                    case 2:
                        balances = _a.sent();
                        tokenId = sendP2SHConfig.tokenId;
                        sendAmount = sendP2SHConfig.sendAmount;
                        return [4 /*yield*/, bitboxNetwork.getTokenInformation(tokenId)];
                    case 3:
                        tokenInfo = _a.sent();
                        tokenDecimals = tokenInfo.decimals;
                        ...
                        inputUtxos = [
                            {
                                txid: "9022f8812be27ab905aef00205b23c9c56b954868b3b4a8fdf748fbbf8ded90d",
                                vout: 1,
                                amount: 0.00000546,
                                satoshis: 546
                            }
                        ...
                        // 6) Set the proper private key for each Utxo
                        inputUtxos.forEach(function (txo) { return (txo.wif = fundingWif); });
                        return [4 /*yield*/, bitboxNetwork.p2shTokenSend(sendP2SHConfig.fundingWif, tokenId, sendAmount, inputUtxos, sendP2SHConfig.tokenReceiverWif, sendP2SHConfig.bchChangeReceiverWif)];
                    case 4:
                        sendTxid = _a.sent();
                        return [2 /*return*/, sendTxid
                            // 3) Multiply the specified token quantity by 10^(token decimal precision)
    ...
    TokenType1.prototype.burnAllP2SH = function (burnAllP2SHConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var fundingWif, ecpair, fundingAddress, tmpBITBOX_7, getRawTransactions, slpValidator, bitboxNetwork, tokenInfo, tokenDecimals, script, p2sh_hash160, scriptPubKey, p2shAddress, balances, bchChangeReceiverECPair, bchChangeReceiverCashAddr, bchChangeReceiverAddress, inputUtxos, network, transactionBuilder, originalAmount, byteCount, sendAmount, script2, children, encodedScript2, encodedScript3, tx, hex, txid, error_7;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        fundingWif = burnAllP2SHConfig.fundingWif;
                        ecpair = this.BITBOX.ECPair.fromWIF(burnAllP2SHConfig.fundingWif);
                        fundingAddress = this.BITBOX.ECPair.toCashAddress(ecpair);
                        tmpBITBOX_7 = this.returnBITBOXInstance(fundingAddress);
                        getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tmpBITBOX_7.RawTransactions.getRawTransaction(txids)];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            });
                        }); };
                        slpValidator = new slpjs.LocalValidator(tmpBITBOX_7, getRawTransactions);
                        bitboxNetwork = new slpjs.BitboxNetwork(tmpBITBOX_7, slpValidator);
                        return [4 /*yield*/, bitboxNetwork.getTokenInformation(burnAllP2SHConfig.tokenId)];
                    case 1:
                        tokenInfo = _a.sent();
                        tokenDecimals = tokenInfo.decimals;
                        script = this.BITBOX.Script.encode([
                    ...
                    case 2:
                        balances = _a.sent();
                        bchChangeReceiverECPair = this.BITBOX.ECPair.fromWIF(burnAllP2SHConfig.bchChangeReceiverWif);
                        bchChangeReceiverCashAddr = this.BITBOX.ECPair.toCashAddress(bchChangeReceiverECPair);
                        bchChangeReceiverAddress = addy.toSLPAddress(bchChangeReceiverCashAddr);
                        if (!addy.isSLPAddress(bchChangeReceiverAddress))
                            throw new Error("Change receiver address not in SLP format.");
                        inputUtxos = [
                            {
                                txid: "dacf425b697ad7c98576efcc31d13bab4e649598d532223e8e2332685b5f5ec2",
                                vout: 1,
                                amount: 0.00000546,
                                satoshis: 546
                            }
                        ...
                        inputUtxos = inputUtxos.concat(balances.nonSlpUtxos);
                        inputUtxos.forEach(function (txo) { return (txo.wif = burnAllP2SHConfig.fundingWif); });
                        network = this.returnNetwork(fundingAddress);
                        transactionBuilder = void 0;
                        if (network === "mainnet") {
                            transactionBuilder = new tmpBITBOX_7.TransactionBuilder("mainnet");
                        }
                        else {
                            transactionBuilder = new tmpBITBOX_7.TransactionBuilder("testnet");
                        }
                        originalAmount = 0;
                        ...
                        transactionBuilder.addInput(inputUtxos[1].txid, inputUtxos[1].vout);
                        originalAmount += inputUtxos[1].satoshis;
                        byteCount = tmpBITBOX_7.BitcoinCash.getByteCount({ P2PKH: inputUtxos.length }, { P2PKH: 3 });
                        sendAmount = originalAmount - byteCount;
                        transactionBuilder.addOutput(p2shAddress, sendAmount);
                        script2 = [Buffer.from("CAR", "ascii")];
                        children = script2.concat(script);
                        encodedScript2 = this.BITBOX.Script.encode(children);
                        encodedScript3 = this.BITBOX.Script.encode(children);
                        // set input script
                        ...
                        hex = tx.toHex();
                        return [4 /*yield*/, tmpBITBOX_7.RawTransactions.sendRawTransaction(hex)];
                    case 3:
                        txid = _a.sent();
                        return [2 /*return*/, txid];
                    case 4:
    ...
    TokenType1.prototype.burnP2SH = function (burnP2SHConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var fundingWif, ecpair, fundingAddress, tmpBITBOX_8, getRawTransactions, slpValidator, bitboxNetwork, tokenInfo, tokenDecimals, script, p2sh_hash160, scriptPubKey, p2shAddress, balances, inputUtxos, burnTxid, error_8;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        fundingWif = burnP2SHConfig.fundingWif;
                        ecpair = this.BITBOX.ECPair.fromWIF(burnP2SHConfig.fundingWif);
                        fundingAddress = this.BITBOX.ECPair.toCashAddress(ecpair);
                        tmpBITBOX_8 = this.returnBITBOXInstance(fundingAddress);
                        getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tmpBITBOX_8.RawTransactions.getRawTransaction(txids)];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            });
                        }); };
                        slpValidator = new slpjs.LocalValidator(tmpBITBOX_8, getRawTransactions);
                        bitboxNetwork = new slpjs.BitboxNetwork(tmpBITBOX_8, slpValidator);
                        return [4 /*yield*/, bitboxNetwork.getTokenInformation(burnP2SHConfig.tokenId)];
                    case 1:
                        tokenInfo = _a.sent();
                        tokenDecimals = tokenInfo.decimals;
                        script = this.BITBOX.Script.encode([
                    ...
                    case 2:
                        ...
                        inputUtxos = [
                            {
                                txid: "0684706ad04b82167c286610ad33901353f900aab9cd48a4bc43ab4521c7951d",
                                vout: 1,
                                amount: 0.00000546,
                                satoshis: 546
                            }
                        ...
                        inputUtxos = inputUtxos.concat(balances.nonSlpUtxos);
                        inputUtxos.forEach(function (txo) { return (txo.wif = burnP2SHConfig.fundingWif); });
                        return [4 /*yield*/, bitboxNetwork.p2shTokenBurn(fundingWif, burnP2SHConfig.tokenId, burnP2SHConfig.burnAmount, inputUtxos, burnP2SHConfig.bchChangeReceiverWif)];
                    case 3:
                        burnTxid = _a.sent();
                        return [2 /*return*/, burnTxid
                            // let network: string = this.returnNetwork(fundingAddress)
