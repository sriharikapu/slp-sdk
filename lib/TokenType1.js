...
var TokenType1 = /** @class */ (function () {
    ...
    TokenType1.prototype.createP2MS = function (createP2MSConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var tmpBITBOX, getRawTransactions, slpValidator, bitboxNetwork, fundingAddress, fundingWif, tokenReceiverAddresses, batonReceiverAddresses, bchChangeReceiverAddresses, balances, decimals, name, symbol, documentUri, documentHash, initialTokenQty, genesisTxid;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tmpBITBOX = this.returnBITBOXInstance(createP2MSConfig.fundingAddress);
                        getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tmpBITBOX.RawTransactions.getRawTransaction(txids)];
                        ...
                        slpValidator = new slpjs.LocalValidator(tmpBITBOX, getRawTransactions);
                        bitboxNetwork = new slpjs.BitboxNetwork(tmpBITBOX, slpValidator);
                        fundingAddress = addy.toSLPAddress(createP2MSConfig.fundingAddress);
                        fundingWif = createP2MSConfig.fundingWif;
                        tokenReceiverAddresses = createP2MSConfig.tokenReceiverAddresses.map(function (address) {
                            return addy.toSLPAddress(address);
                        });
                        if (createP2MSConfig.batonReceiverAddresses[0] !== undefined &&
                            createP2MSConfig.batonReceiverAddresses[0] !== "" &&
                            createP2MSConfig.batonReceiverAddresses[0] !== null) {
                            batonReceiverAddresses = createP2MSConfig.batonReceiverAddresses.map(function (address) {
                                return addy.toSLPAddress(address);
                            });
                        }
                        else {
                        ...
                        bchChangeReceiverAddresses = createP2MSConfig.bchChangeReceiverAddresses.map(function (address) {
                            return addy.toSLPAddress(address);
                        });
                        return [4 /*yield*/, bitboxNetwork.getAllSlpBalancesAndUtxos(fundingAddress)];
                    case 1:
                        ...
                        initialTokenQty = new BigNumber(initialTokenQty).times(Math.pow(10, decimals));
                        balances.nonSlpUtxos.forEach(function (txo) { return (txo.wif = fundingWif); });
                        return [4 /*yield*/, bitboxNetwork.p2msTokenGenesis(name, symbol, initialTokenQty, documentUri, documentHash, decimals, tokenReceiverAddresses, createP2MSConfig.tokenReceiverWifs, batonReceiverAddresses, createP2MSConfig.batonReceiverWifs, bchChangeReceiverAddresses, createP2MSConfig.bchChangeReceiverWifs, balances.nonSlpUtxos, createP2MSConfig.requiredSignatures)];
                    case 2:
                        genesisTxid = _a.sent();
                        return [2 /*return*/, genesisTxid];
                }
    ...
    TokenType1.prototype.mintP2MS = function (mintP2MSConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var BITBOX, tmpECPair, cashAddress, tmpBITBOX, getRawTransactions, slpValidator, bitboxNetwork, mintPubkeys, mintBuf, scriptHash, data2, fundingAddress, fundingWif, tokenReceiverAddress, batonReceiverAddress, bchChangeReceiverAddress, tokenId, additionalTokenQty, balances, tokenInfo, tokenDecimals, mintQty, inputUtxos, mintTxid;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        BITBOX = new BITBOXSDK();
                        tmpECPair = BITBOX.ECPair.fromWIF(mintP2MSConfig.tokenReceiverWifs[0]);
                        cashAddress = BITBOX.ECPair.toCashAddress(tmpECPair);
                        tmpBITBOX = this.returnBITBOXInstance(cashAddress);
                        getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tmpBITBOX.RawTransactions.getRawTransaction(txids)];
                        ...
                        bitboxNetwork = new slpjs.BitboxNetwork(tmpBITBOX, slpValidator);
                        mintPubkeys = [];
                        mintP2MSConfig.tokenReceiverWifs.forEach(function (wif) {
                            var ecpair = tmpBITBOX.ECPair.fromWIF(wif);
                        ...
                        mintBuf = tmpBITBOX.Script.multisig.output.encode(mintP2MSConfig.requiredSignatures, mintPubkeys);
                        scriptHash = tmpBITBOX.Crypto.hash160(mintBuf);
                        console.log("scriptHash", scriptHash);
                        data2 = tmpBITBOX.Script.scriptHash.output.encode(scriptHash);
