...
var TokenType1 = /** @class */ (function () {
    ...
    TokenType1.prototype.create = function (createConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var tmpBITBOX, slpValidator, bitboxNetwork, fundingAddress, fundingWif, tokenReceiverAddress, batonReceiverAddress, bchChangeReceiverAddress, balances, decimals, name, symbol, documentUri, documentHash, initialTokenQty, genesisTxid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tmpBITBOX = this.returnBITBOXInstance(createConfig.fundingAddress);
                        slpValidator = this.returnLocalValidator(tmpBITBOX);
    ...
    TokenType1.prototype.mint = function (mintConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var tmpBITBOX, slpValidator, bitboxNetwork, fundingAddress, fundingWif, tokenReceiverAddress, batonReceiverAddress, bchChangeReceiverAddress, tokenId, additionalTokenQty, balances, tokenInfo, tokenDecimals, mintQty, inputUtxos, mintTxid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    TokenType1.prototype.send = function (sendConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var tmpBITBOX, slpValidator, bitboxNetwork, fundingAddress, fundingWif, tokenReceiverAddress, bchChangeReceiverAddress, tokenId, amount, tokenInfo, tokenDecimals, balances, inputUtxos, sendTxid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    TokenType1.prototype.burnAll = function (burnAllConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var tmpBITBOX, slpValidator, bitboxNetwork, balances, inputUtxos, network, transactionBuilder_1, originalAmount_1, byteCount, sendAmount, keyPair_1, redeemScript_1, tx, hex, txid, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        tmpBITBOX = this.returnBITBOXInstance(burnAllConfig.fundingAddress);
                        slpValidator = this.returnLocalValidator(tmpBITBOX);
                        bitboxNetwork = new slpjs.BitboxNetwork(tmpBITBOX, slpValidator);
                    ...
                    case 1:
                        ...
                        if (network === "mainnet") {
                            transactionBuilder_1 = new tmpBITBOX.TransactionBuilder("mainnet");
                        }
                        else {
                            transactionBuilder_1 = new tmpBITBOX.TransactionBuilder("testnet");
                        }
                        originalAmount_1 = 0;
                        ...
                        byteCount = tmpBITBOX.BitcoinCash.getByteCount({ P2PKH: inputUtxos.length }, { P2PKH: 1 });
                        ...
                        keyPair_1 = tmpBITBOX.ECPair.fromWIF(burnAllConfig.fundingWif);
                        ...
                        hex = tx.toHex();
                        return [4 /*yield*/, tmpBITBOX.RawTransactions.sendRawTransaction(hex)];
                    case 2:
                        txid = _a.sent();
    ...
    TokenType1.prototype.burn = function (burnConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var tmpBITBOX, slpValidator, bitboxNetwork, mnemonic, rootSeed, network, masterHDNode, account, change, cashAddress, wif, sendConfig, successTxid, transactionBuilder_2, originalAmount_2, balances, inputUtxos, byteCount, sendAmount, keyPair_2, redeemScript_2, tx, hex, txid, burnAllConfig, burnAllTxid, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        ...
                        slpValidator = this.returnLocalValidator(tmpBITBOX);
                        bitboxNetwork = new slpjs.BitboxNetwork(tmpBITBOX, slpValidator);
                        mnemonic = tmpBITBOX.Mnemonic.generate(128);
                        rootSeed = tmpBITBOX.Mnemonic.toSeed(mnemonic);
                        ...
                        account = tmpBITBOX.HDNode.derivePath(masterHDNode, "m/44'/145'/0'");
                        change = tmpBITBOX.HDNode.derivePath(account, "0/0");
                        cashAddress = tmpBITBOX.HDNode.toCashAddress(change);
                        wif = tmpBITBOX.HDNode.toWIF(change);
                        sendConfig = {
                        ...
                        return [4 /*yield*/, this.send(sendConfig)];
                    case 1:
                        successTxid = _a.sent();
                        console.log("SEND SUCCESS Txid", successTxid);
                        if (network === "mainnet") {
                            transactionBuilder_2 = new tmpBITBOX.TransactionBuilder("mainnet");
                        }
                        else {
                            transactionBuilder_2 = new tmpBITBOX.TransactionBuilder("testnet");
                        }
                        originalAmount_2 = 0;
                        return [4 /*yield*/, bitboxNetwork.getAllSlpBalancesAndUtxos(burnConfig.fundingAddress)];
                    case 2:
                        balances = _a.sent();
                        inputUtxos = balances.nonSlpUtxos;
                        inputUtxos.forEach(function (utxo) {
                            // index of vout
                            var vout = utxo.vout;
                            // txid of vout
                            var txid = utxo.txid;
                            // add input with txid and index of vout
                            transactionBuilder_2.addInput(txid, vout);
                            originalAmount_2 += utxo.satoshis;
                        });
                        byteCount = tmpBITBOX.BitcoinCash.getByteCount({ P2PKH: inputUtxos.length }, { P2PKH: 1 });
                        sendAmount = originalAmount_2 - byteCount;
                        transactionBuilder_2.addOutput(cashAddress, sendAmount);
                        keyPair_2 = tmpBITBOX.ECPair.fromWIF(burnConfig.fundingWif);
                        inputUtxos.forEach(function (utxo, index) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.burnAll(burnAllConfig)];
                    case 4:
                        burnAllTxid = _a.sent();
                        console.log("BURNALLTXID", burnAllTxid);
                        return [2 /*return*/, burnAllTxid];
                    case 5:
                        error_2 = _a.sent();
    ...
    TokenType1.prototype.returnLocalValidator = function (tmpBITBOX) {
        var _this = this;
        var getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
